...
<li><b>Step 1:<//b> Deploy k8s Infrastructure using Heat and Ansible.<br>
<li><b>Step 2:</b> Install k8s using Ansible.<br>
<li><b>Step 3:</b> Configure k8s and additional services using Ansible.<br>
